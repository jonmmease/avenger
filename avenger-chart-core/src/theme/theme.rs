    ...
    fn default_theme() -> Self {
        let css = r#"
            ...
            :root {
                ...
                /* Guide elements: Subtle, between grid and tertiary text, 60% toward background */
                --guide-color: color-mix(in srgb, var(--text-color) 40%, var(--bg-color) 60%);
