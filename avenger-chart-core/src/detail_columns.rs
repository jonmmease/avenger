use crate::{AvengerChartError, CompiledMarkCore, detail_array_column_name};
use datafusion::{
...
impl DetailColumns {
    ...
    pub fn key_for_row(&self, row: usize) -> Result<Vec<ScalarValue>, AvengerChartError> {
        self.arrays
            .iter()
            .map(|array| {
