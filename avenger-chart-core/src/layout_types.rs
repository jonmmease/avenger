...
use crate::{AxisPosition, FacetAxis, LegendPosition, OverflowSpaceRequirement};
...
mod tests {
    ...
    fn residual_overflow_after_owned_legend_slabs_preserves_guides() {
        ...
        assert_eq!(demand.guide_slabs, EdgeSlabs::new(10.0, 20.0, 30.0, 40.0));
    ...
    #[test]
    fn edge_slabs_round_trip_with_overflow_requirement() {
        ...
        assert_eq!(slabs, EdgeSlabs::new(1.0, 2.0, 3.0, 4.0));
        let round_trip = OverflowSpaceRequirement::from(slabs);
        assert_eq!(round_trip, overflow);
    }

    #[test]
    fn edge_slab_side_helpers_follow_axis_orientation() {
