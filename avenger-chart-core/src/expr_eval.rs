...
use crate::{
    AvengerChartError, AxisPosition, LegendOrientation, LegendPosition, ScalarValueHelpers,
    eval_to_scalars, params_to_datafusion,
};

/// Helper function to evaluate an expression to a concrete f32 value
pub async fn evaluate_f32_expr(
    expr: &Expr,
    ctx: &SessionContext,
...
pub async fn evaluate_string_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
pub async fn evaluate_bool_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
pub async fn evaluate_i32_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
#[allow(dead_code)]
pub async fn evaluate_usize_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
pub async fn evaluate_f64_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
pub async fn evaluate_axis_position_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
pub async fn evaluate_legend_position_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
...
#[allow(dead_code)]
pub async fn evaluate_legend_orientation_expr(
    expr: &Expr,
    ctx: &SessionContext,
    params: &IndexMap<String, ScalarValue>,
