//! Decorated treemap click-to-zoom using hierarchy event datum fields.
//!
//! Click a parent header bar or collapsed cell to focus the treemap on that
//! hierarchy path. Click breadcrumbs or double-click anywhere to zoom out.
//!
//! Run with:
//! ```bash
//! cargo run -p avenger-chart-app --example treemap_decorated_click_to_zoom --features winit-wgpu --release
//! ```
...
use avenger_chart_treemap::{
    ...
    TreemapPadding, event as treemap_event,
};
use datafusion::{
    arrow::{
...
fn main() {
    ...
    let options = WinitWgpuAvengerAppOptions::new(2.0).window_attributes(
        WindowAttributes::default()
            .with_title("avenger-chart decorated treemap click to zoom")
