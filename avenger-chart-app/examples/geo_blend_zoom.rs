//! Adaptive projection blend demo (scratch/geo phase 5b): the CONUS
//! Albers choropleth morphs into Web Mercator as you zoom in, so
//! street-level interaction behaves like a slippy map — the Mapbox
//! "adaptive projections" behavior.
//!
//! Scroll to zoom into a metro area and watch the graticule straighten;
//! double-click to reset to the fitted Albers view.
//!
//! Run with:
//! ```bash
//! cargo run --release -p avenger-chart-app --example geo_blend_zoom --features winit-wgpu
//! ```
...
use avenger_chart_geo::{BlendConfig, Geo, GeoPanZoom, GeoShape, GraticuleStyle, register_geojson};
...
fn main() {
    ...
    let options = WinitWgpuAvengerAppOptions::new(2.0).window_attributes(
        WindowAttributes::default()
            .with_title("avenger-chart Geo: adaptive Albers-to-Mercator blend")
