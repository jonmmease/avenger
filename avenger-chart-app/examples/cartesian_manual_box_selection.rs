...
async fn build_app() -> avenger_app::app::AvengerApp<avenger_chart_app::ChartAppState> {
    ...
    let overlay = Rect::<Cartesian>::new()
        ...
        .x_with(col("box_left"), |c| c.exclude_from_scale_domain())
        .x2_with(col("box_right"), |c| c.exclude_from_scale_domain())
        .y_with(col("box_bottom"), |c| c.exclude_from_scale_domain())
        .y2_with(col("box_top"), |c| c.exclude_from_scale_domain())
