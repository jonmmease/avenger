...
use avenger_chart_core::{
    ...
    MarkAdjustmentTransform, MarkState, OpacityChannelConfig, PatternChannelValue,
    PrimitiveMarkEffects, RectGeometryItem, StrokeWidthChannelConfig, TransformMarkAdjustmentSpec,
