...
use avenger_chart_core::{
    ...
    PatternChannelValue, PointGeometryItem, PrimitiveMarkEffects, StrokeAdjustmentChannel,
    StrokeCapAdjustmentChannel, StrokeJoinAdjustmentChannel, StrokeWidthAdjustmentChannel,
