...
use crate::{compiled::util, rect_channel_defaults};
use avenger_chart_core::{
    ...
    ItemChannelAssignment, LegendRendererKind, LegendRendererSelection, MarkAdjustmentSpec,
    ...
    coerce_pattern_channel_with_renderer, default_scale_type_for_data_type, is_continuous_scale,
...
impl CompiledMarkCore for CompiledRect {
...
#[typetag::serde(name = "CompiledCartesianRect")]
#[cfg_attr(target_arch = "wasm32", async_trait::async_trait(?Send))]
#[cfg_attr(not(target_arch = "wasm32"), async_trait::async_trait)]
impl CompiledMark for CompiledRect {
...
impl CompiledRect {
    ...
    fn render_rect_scene(
        ...
        // Rectangles transform both corners through the active coordinate frame.
