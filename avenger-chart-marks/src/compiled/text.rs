use crate::{compiled::util, text_channel_defaults};
use avenger_chart_core::{
    AvengerChartError, ChannelDescriptor, CompiledDataContext, CompiledMark, CompiledMarkCore,
    CompiledMarkState, CoordinateSystemTransformCore, LegendRendererSelection, MarkRuntimeContext,
    PrimitiveMarkEffects, RenderedMarkData, ScaleTypePreference, default_scale_type_for_data_type,
    is_continuous_scale,
...
impl CompiledMarkCore for CompiledText {
...
#[typetag::serde(name = "CompiledCartesianText")]
#[cfg_attr(target_arch = "wasm32", async_trait::async_trait(?Send))]
#[cfg_attr(not(target_arch = "wasm32"), async_trait::async_trait)]
impl CompiledMark for CompiledText {
...
impl CompiledText {
    pub(crate) fn render_text_scene(
        ...
        let position =
            util::transform_point_channels(self, data, scalars, context, coord, "x", "y")?;
