...
Datetime definitions come from d3-time-format 4.1.0, with its license beside the locale files. Local datetime reference cases run in separate processes with explicit timezones.
