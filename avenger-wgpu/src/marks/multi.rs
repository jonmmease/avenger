...
mod tests {
    ...
    fn patterned_bar_chart_render_pass_count_is_linear_in_visible_bars() {
        ...
        fill_only_renderer
            ...
            .unwrap();
        let fill_only_estimate = fill_only_renderer
            .estimate_render_passes_for_ranges(&[0..fill_only_renderer.batch_count()]);
        ...
        patterned_renderer
            ...
            .unwrap();
        let patterned_estimate = patterned_renderer
            .estimate_render_passes_for_ranges(&[0..patterned_renderer.batch_count()]);
