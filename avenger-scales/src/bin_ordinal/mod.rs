...
mod tests {
    ...
    fn test_bin_ordinal_scale_basic() -> Result<(), AvengerScaleError> {
        ...
        assert_eq!(result[2], "red"); // Third bin wraps back to first color
        assert_eq!(result[3], "black"); // Out of domain maps to default
    ...
    fn test_bin_ordinal_scale_out_of_domain() -> Result<(), AvengerScaleError> {
        ...
        assert_eq!(result[2], "black"); // Above last bin
    ...
    fn test_bin_ordinal_scale_numeric() -> Result<(), AvengerScaleError> {
        ...
        assert_approx_eq!(f32, result[2], 10.0); // Third bin -> back to first value
        assert_approx_eq!(f32, result[3], 20.0); // Fourth bin -> back to second value
