...
mod tests {
    ...
    fn test_number_formatting_default() {
        ...
        let formatter = DefaultFormatter::default().prepare_number().unwrap();
        let values = vec![
            Some(1.0),
            Some(2.5),
        ...
        let result = NumberFormatter::format(&formatter, &values, Some("N/A"));
    ...
    fn test_number_formatting_with_format_string() {
        ...
        let result = NumberFormatter::format(&formatter, &values, Some("--"));
    ...
    fn test_formatting_empty_arrays() {
        ...
        let number_formatter = DefaultFormatter::default().prepare_number().unwrap();
