...
- [x] Add owned simple `lr(...)` delimiter scaling for one-line labels whose first and last non-space argument nodes are supported delimiter pairs, with path/PDF output and no delegate initialization.
