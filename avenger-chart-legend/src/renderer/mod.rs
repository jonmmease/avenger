...
use avenger_chart_core::{AvengerChartError, Legend, LegendRendererKind, Size2D, Theme};
use avenger_chart_scales::{ConfiguredScaleLegendExt, DomainValues};
...
pub mod helpers {
    ...
    use avenger_chart_core::{ChannelValue, ScalarValueHelpers, simplify_to_scalar_sync};
