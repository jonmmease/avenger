...
The [annotation editor](../examples/winit-annotation-editor/README.md) runs in a native window or a browser. It edits literal Typst source and displays typeset chart labels. Invalid drafts retain the last valid preview. It combines text selection, composition, clipboard actions, debounced edits, draggable labels, tooltips, and prepared sample replacement.
