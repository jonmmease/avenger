        ...
        .mark(
            Symbol::<Cartesian>::new()
                ...
                .fill_with(col("fill_category"), move |c| {
                    c.with_domain_scope(CoordinationScope::Level(fill_sharing_level))
        ...
        .mark(
            Subplot::<Cartesian>::new(positioned_child_plot())
                ...
                .subplot_x_with(col("parent_x"), move |c| {
                    ...
                    .with_domain_scope(CoordinationScope::Level(subplot_x_sharing_level))
                ...
                .subplot_y_with(lit(0.5), move |c| {
                    ...
                    .with_domain_scope(CoordinationScope::Level(subplot_y_sharing_level))
