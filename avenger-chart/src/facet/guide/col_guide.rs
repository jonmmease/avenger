//! FacetColGuide implementation for column-based faceting (stubbed).
//!
...
/// Guide configuration for FacetCol coordinate system (stubbed)
...
/// Compiled guide for FacetCol coordinate system (stubbed)
///
