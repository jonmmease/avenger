...
use avenger_chart_core::{
    ...
    FacetAxis, OverflowSpaceRequirement, SharingLevel,
};
...
pub(crate) struct CoordinationRunArtifacts {
    pub(crate) requirement_pass: RequirementPass,
    pub(crate) adopt_trace: crate::facet::coordination_apply::AdoptTrace,
}
