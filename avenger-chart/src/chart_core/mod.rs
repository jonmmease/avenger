...
pub use avenger_chart_core::{
    ...
    CompiledSubplotChildPlot, CompiledSubplotPayload, ConditionalValue,
    ...
    EdgeSlabs, EmptyCoordMeasurement, ExprHelpers, FacetAxis, FacetDimensionConfig,
    FacetEmptyCellPolicy, FacetStrategy, FrameAllocation, FrameDemand, FrameDimensionSizing,
    ...
    StrokeDashChannelConfig, StrokeWidthChannelConfig, SubplotChildPlotSpec,
    SubplotContainerCoordinateSystem, SubplotDataSource, SubplotGeometry, SubplotMarkCore,
    SubplotRect, axis_owner_ignore_empty_cells_from_params, axis_ownership_mode_from_params,
    ...
    coerce_stroke_join_channel_with_renderer, compile_subplot_payload, contains_aggregate,
    default_channel_value_for_eval, default_scale_type_for_data_type, enumeration_ancestor_path,
