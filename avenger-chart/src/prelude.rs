...
pub use crate::bake::{BakePolicy, PlotBakeReport};
...
pub use avenger_chart_core::{
    ...
    MaterializationOutputKind, MaterializationPolicy, MaterializationRequest, PlotMark, Selection,
    SelectionClauseUpdate, SelectionCombine, SelectionSceneQuery, SelectionUpdate, Store,
    StoreData, StoreFieldPatch, StoreFieldRef, StoreKey, StoreRow, StoreUpdate, TimeContext, View,
    ViewAsyncPolicy, ViewRef, ViewStalePolicy, WeekStart, ZeroDCoord,
};
pub use avenger_chart_core::{
