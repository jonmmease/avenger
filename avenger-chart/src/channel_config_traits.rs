...
//!
//! This module provides traits that eliminate duplication across channel configs
...
fn add_scaled_condition(current: ChannelValue, condition: Expr, value: Expr) -> ChannelValue {
    let new_branch = ConditionalValue::Field { expr: value };
    ...
    match current {
        ChannelValue::Conditional {
            ...
            conditions.insert(0, (condition, new_branch));
            ChannelValue::Conditional {
                conditions,
                otherwise,
                scale_config,
        ...
        ChannelValue::Scaled {
            ...
            otherwise: ConditionalValue::Field { expr },
            scale_config,
            legend_config,
        },
        ChannelValue::Identity { expr } => ChannelValue::Conditional {
            conditions: vec![(condition, new_branch)],
