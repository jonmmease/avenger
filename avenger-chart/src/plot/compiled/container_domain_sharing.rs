...
mod tests {
    ...
    use avenger_chart_core::{
        AxisSpec, CompiledGuide, CompiledMark, CoordinateDomainBinding, CoordinateDomainCellKey,
    ...
    fn fake_compiled_plot(sharing_policy: CoordinateDomainSharingPolicy) -> CompiledPlot {
        CompiledPlot {
            ...
            mark_runtime_paths: Default::default(),
            ...
            param_specs: Default::default(),
            store_specs: Default::default(),
