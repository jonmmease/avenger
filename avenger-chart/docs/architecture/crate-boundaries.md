...
| `avenger-chart-tools` | Built-in chart tools that expand into core tool contracts. `PanScrollZoom` and `BoxZoom` live here and emit generated params, raw-domain scale edits, event bindings, marks, and tool metadata. |
