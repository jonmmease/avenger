...
| `avenger-chart-tools` | Built-in chart tools that expand into core tool contracts. `PanScrollZoom` lives here and emits generated params, raw-domain scale edits, event bindings, and tool metadata. |
