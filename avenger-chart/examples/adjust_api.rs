...
use avenger_chart::adjust::{Jitter, Dodge, PlotDimensions, Adjust, AdjustFn, TransformContext};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let test_dims = PlotDimensions { width: 800.0, height: 600.0 };
