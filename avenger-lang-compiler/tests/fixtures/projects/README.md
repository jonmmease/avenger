...
`08_multi_chart_project` is the incremental-compilation fixture: three chart
entrypoints have isolated parameters while the cartesian and polar charts share
