...
pub fn build_rect_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneRectMark, AvengerRuntimeError> {
    // Build coercer
...
pub fn build_arc_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneArcMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_area_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneAreaMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_image_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneImageMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_line_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneLineMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_path_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<ScenePathMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_rule_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneRuleMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_symbol_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneSymbolMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_text_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneTextMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
...
pub fn build_trail_mark(encoded_data: &ArrowTable, config: &ArrowTable) -> Result<SceneTrailMark, AvengerRuntimeError> {
    // Build coercer
    let coercer = Coercer::default();
