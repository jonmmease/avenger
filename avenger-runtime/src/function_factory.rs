...
use datafusion::{execution::{context::{FunctionFactory, RegisterFunction}, SessionState}, logical_expr::{simplify::{ExprSimplifyResult, SimplifyInfo}, sort_properties::{ExprProperties, SortProperties}, ColumnarValue, CreateFunction, ScalarFunctionArgs, ScalarUDF, ScalarUDFImpl, Signature, Volatility}, prelude::Expr};
use datafusion_common::{exec_err, internal_err, tree_node::{Transformed, TreeNode}, DataFusionError};

/// This is our FunctionFactory that is responsible for converting `CREATE
/// FUNCTION` statements into function instances
#[derive(Debug, Default)]
pub struct CustomFunctionFactory {}
